...
namespace Parfonov_RE_21mp_LR5
{
    public partial class Form1 : Form
    {
        ...
        private void bStart_Click(object sender, EventArgs e)
        {
            ...
            long l_mb = new FileInfo(tInFilePath.Text).Length;// / (2 ^ 20);
            label_mb.Text = Convert.ToString(l_mb);
            stopwatch.Start();
            ...
            long l_b = new FileInfo(tOutFilePath.Text).Length;
            label_b.Text = Convert.ToString(l_b);

            string result = BitConverter.ToString(outArr).Replace("-", "");
            MessageBox.Show("У файл записане число:\n" + result, "Результат", MessageBoxButtons.OK, MessageBoxIcon.Information);
...
"“HASH файлу або цифровий підпис або контрольна сума”" + "\r\n");
        }
    }
}
